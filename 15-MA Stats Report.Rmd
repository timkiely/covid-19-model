---
title: "MA City/Town Virus Counts"
date: "`r Sys.Date()`"
output:
  pdf_document:
    toc: true
...
infection_rate_df <- 
  ...
  select(-contains("Percent Increase"),-`Increase Since First Report On April 15`,-`Confirmed Cases`) %>% 
...
# Total Count and Percent Increase
...
# Map Of Increases In Counts This Week
...
# Map Of % Increases in Count This Week (>10% and >10 cases)
...
# Top 100 Percent Change Since Last Week
